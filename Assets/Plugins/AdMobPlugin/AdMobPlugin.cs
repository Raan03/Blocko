...
namespace AssemblyCSharpfirstpass.Plugins.AdMobPlugin
{
	...
	public class AdMobPlugin : MonoBehaviour
	{
		...
		public static event System.Action ReceivedAd = delegate {
				};
		public static event System.Action<string> FailedToReceiveAd = delegate {
				};
		public static event System.Action ShowingOverlay = delegate {
				};
		public static event System.Action DismissedOverlay = delegate {
				};
		public static event System.Action LeavingApplication = delegate {
				};
		...
		public static void OnReceiveAd (string unusedMessage)
		{
			ReceivedAd ();
		}

		public static void OnFailedToReceiveAd (string message)
		{
			FailedToReceiveAd (message);
		}

		public static void OnPresentScreen (string unusedMessage)
		{
			ShowingOverlay ();
		}

		public static void OnDismissScreen (string unusedMessage)
		{
			DismissedOverlay ();
		}

		public static void OnLeaveApplication (string unusedMessage)
		{
			LeavingApplication ();
		}
	}
